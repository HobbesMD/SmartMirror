...
Module.register("MMM-WeatherGVSU",{

	defaults: {
		  languages: "",              // checkoout the language list
			tempUnits: "",              // I have it set at F but C works too
			textColor: "",              // Hex color codes.
			font: "",                   // checkout font list
      ...
      snowColor: "",              // Hex color codes.
			...
			location: "",               // grab location code via website listed on readme
			locationCode: "",           
			label: "",                 
			label2: "",                
			days: "",                   // 3, 5 or 7
