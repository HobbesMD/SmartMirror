...
| TC7 | Set config file according to input values, run program and check display | Set config file according to input values, run program and check display |  |  |  |  |  |
| TC8 | Set config file according to input values, run program and check display | Set config file according to input values, run program and check display |  |  |  |  |  |
| TC9| Set config file according to input values, run program and check display | Set config file according to input values, run program and check display |  |  |  |  |  |
...
| TC13 | Test animations works with each weather component and day |  |  |  |  |  |  |
| TC14 |  |  |  |  |  |  |  |
| TC15 |  |  |  |  |  |  |  |
