...
| TC7 | Test user can configure width and height| Set config file according to input values, run program and check display | In config.js, ```height: "300px", width: "1300px"```  |  |  |  |  |
