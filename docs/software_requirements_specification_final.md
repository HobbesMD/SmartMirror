...
| TC7 | Set config file according to input values, run program and check display |  |  |  |  |  |  |
| TC8 | Set config file according to input values, run program and check display |  |  |  |  |  |  |
